...
image:
  path: /assets/img/posts/OSO.png
  alt: "Rocket launch emoji representing the launch of an Open Source Office"
---
...
I didn't know it at the time but what I had stumbled upon was a commonly experienced problem that open source and InnerSource had a solution for. After doing some research and stumbling on the [TODO Group](https://todogroup.org/) I found that the company could improve our efficiency by so much if we adopted open/inner source practices.
